...
#ifndef __CANFESTIVAL_APPLICFG__
#define __CANFESTIVAL_APPLICFG__
...
/*!
 * \todo merge with inttypes.h/stdint.h
 */
...
#define CANFESTIVAL_DEBUG_DRV_MSG(...) MSG(__VA_ARGS__);
